                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8 py-3 flex items-center justify-between gap-2 sm:gap-4">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 text-xs font-bold shrink-0">
                        ...
                        >
                            ...
                            <span className={`absolute -top-1 -right-1 bg-rose-600 text-white font-mono text-[9px] font-bold min-w-4 h-4 px-1 rounded-full flex items-center justify-center border border-slate-900 shadow-md transition-all ${wishlistCount > 0 ? 'scale-100 opacity-100' : 'scale-0 opacity-0'
                                }`}>
                                {wishlistCount}
                            </span>
                        </Link>
                        ...
                        >
                            ...
                            <span className={`absolute -top-1 -right-1 bg-indigo-500 text-white font-mono text-[9px] font-bold min-w-4 h-4 px-1 rounded-full flex items-center justify-center border border-slate-900 shadow-md transition-all ${cartCount > 0 ? 'scale-100 opacity-100' : 'scale-0 opacity-0'
                                }`}>
                                {cartCount}
                            </span>
                        </Link>
